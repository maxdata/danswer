...
from backend.configs.app_configs import POSTGRES_DB
from backend.configs.app_configs import POSTGRES_HOST
from backend.configs.app_configs import POSTGRES_PASSWORD
from backend.configs.app_configs import POSTGRES_PORT
from backend.configs.app_configs import POSTGRES_USER
from backend.document_index.vespa.index import DOCUMENT_ID_ENDPOINT
