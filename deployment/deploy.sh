...
docker compose -f deployment/docker-compose.db.yml -p danswer-stack down -v

# db only
docker compose -f deployment/docker-compose.db.yml -p danswer-stack up -d --pull always --force-recreate
