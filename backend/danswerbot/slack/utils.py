...
from backend.configs.constants import ID_SEPARATOR
from backend.configs.constants import MessageType
from backend.configs.danswerbot_configs import DANSWER_BOT_MAX_QPM
from backend.configs.danswerbot_configs import DANSWER_BOT_MAX_WAIT_TIME
...
from backend.connectors.slack.utils import SlackTextCleaner
...
def read_slack_thread(
    ...
    for reply in replies:
        if "user" in reply and "bot_id" not in reply:
            ...
            # Only include bot messages from backend, other bots are not taken in as context
