...
from backend.background.indexing.checkpointing import get_time_windows_for_index_attempt
from backend.configs.app_configs import POLL_CONNECTOR_OFFSET
from backend.connectors.factory import instantiate_connector
...
from backend.connectors.models import IndexAttemptMetadata
from backend.connectors.models import InputType
from backend.db.connector import disable_connector
from backend.db.connector_credential_pair import get_last_successful_attempt_time
from backend.db.connector_credential_pair import update_connector_credential_pair
from backend.db.credentials import backend_update_credential_json
...
from backend.db.index_attempt import mark_attempt_in_progress
from backend.db.index_attempt import mark_attempt_succeeded
from backend.db.index_attempt import update_docs_indexed
...
from backend.indexing.embedder import DefaultIndexingEmbedder
from backend.indexing.indexing_pipeline import build_indexing_pipeline
from backend.utils.logger import IndexAttemptSingleton
