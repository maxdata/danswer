...
from backend.configs.app_configs import INDEX_BATCH_SIZE
from backend.configs.constants import DocumentSource
from backend.connectors.cross_connector_utils.file_utils import detect_encoding
from backend.connectors.cross_connector_utils.file_utils import load_files_from_zip
from backend.connectors.cross_connector_utils.file_utils import read_file
from backend.connectors.cross_connector_utils.file_utils import read_pdf_file
from backend.connectors.cross_connector_utils.miscellaneous_utils import time_str_to_utc
from backend.connectors.file.utils import check_file_ext_is_valid
from backend.connectors.file.utils import get_file_ext
...
from backend.connectors.models import Section
