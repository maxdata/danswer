...
from backend.configs.app_configs import DISABLE_AUTH
from backend.configs.app_configs import EMAIL_FROM
from backend.configs.app_configs import REQUIRE_EMAIL_VERIFICATION
from backend.configs.app_configs import SECRET
from backend.configs.app_configs import SESSION_EXPIRE_TIME_SECONDS
from backend.configs.app_configs import SMTP_PASS
from backend.configs.app_configs import SMTP_PORT
from backend.configs.app_configs import SMTP_SERVER
from backend.configs.app_configs import SMTP_USER
from backend.configs.app_configs import VALID_EMAIL_DOMAINS
from backend.configs.app_configs import WEB_DOMAIN
from backend.configs.constants import AuthType
from backend.db.auth import get_access_token_db
from backend.db.auth import get_user_count
from backend.db.auth import get_user_db
from backend.db.engine import get_session
from backend.db.models import AccessToken
...
async def current_user(
    ...
    double_check_user = fetch_versioned_implementation(
        "backend.auth.users", "double_check_user"
    )
