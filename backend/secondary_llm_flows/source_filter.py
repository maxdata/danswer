...
from backend.db.connector import fetch_unique_document_sources
...
from backend.prompts.constants import SOURCES_KEY
from backend.prompts.filter_extration import FILE_SOURCE_WARNING
from backend.prompts.filter_extration import SOURCE_FILTER_PROMPT
from backend.prompts.filter_extration import WEB_SOURCE_WARNING
...
def extract_source_filter(
    ...
    def _get_source_filter_messages(
        ...
        messages = [
            ...
            {
                "role": "user",
                "content": "What page from backend contains debugging instruction on segfault",
            },
            {
                "role": "assistant",
                "content": json.dumps({SOURCES_KEY: None}),
