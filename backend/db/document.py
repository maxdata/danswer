...
from backend.db.feedback import delete_document_feedback_for_documents
...
from backend.db.tag import delete_document_tags_for_documents
from backend.db.utils import model_to_dict
